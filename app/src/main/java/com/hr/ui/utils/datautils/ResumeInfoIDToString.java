...
public class ResumeInfoIDToString {
	 ...
	 * 获取行业
	 */
	public static String getIndustry(Context context, String id, boolean isCHS) {
		String[] nationIdsStrings = context.getResources().getStringArray(R.array.array_industry_ids);
		String[] nationTextStrings;
		if(context!=null) {
			if (!isCHS) {// en
				nationTextStrings = context.getResources().getStringArray(
						R.array.array_industry_en);
			} else {// zh
				nationTextStrings = context.getResources().getStringArray(
						R.array.array_industry_zh);
			}
			for (int i = 0; i < nationIdsStrings.length; i++) {
				if (nationIdsStrings[i].equals(id)) {
					return nationTextStrings[i];
	...
	public static String getFunc(Context context, String industryId,
		...
		if(context!=null) {
			...
			try {
				...
				String s=SaveFile.getDataFromInternalStorage(context,"job.txt");
	 ...
	 * 获取职称名称
	 */
	public static String getZhiChengId(Context context, String name) {
		if(context!=null) {
			String[] zhichengIdStrings = context.getResources().getStringArray(
					R.array.array_zhicheng_ids);
			String[] zhichengStrings;
	 ...
	 * 获取男女id
	 */
	public static String getSexId(Context context, String name) {
		if(context!=null) {
			String[] zhichengIdStrings = context.getResources().getStringArray(
	 ...
	 * 获取学历id
	 */
	public static String getEducationDegreeId(Context context, String name) {
		if(context!=null) {
			String[] degreeIdStrings = context.getResources().getStringArray(
					R.array.array_degree_ids);
			String[] degreeStrings = context.getResources().getStringArray(
						R.array.array_degree_zh);

			for (int i = 0; i < degreeStrings.length; i++) {
				if (degreeStrings[i].equals(name)) {
					return degreeIdStrings[i];
				}
			}
		}
		return "";
	 ...
	 * 获取语言等级考试
	 */
	public static String getLanguageLevel(Context context, String id,
										 boolean isCHS) {
		if(context!=null) {
			String[] languageTypeIdStrings = context.getResources().getStringArray(
					R.array.array_languageTestLevel_ids);
			String[] languageTypeStrings;

			languageTypeStrings = context.getResources().getStringArray(
						R.array.array_languageTestLevel_zh);
