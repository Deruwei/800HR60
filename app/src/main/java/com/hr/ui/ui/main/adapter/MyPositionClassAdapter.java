...
public class MyPositionClassAdapter extends RecyclerView.Adapter<MyPositionClassAdapter.MyIndustryHolder> {
    ...
    public MyPositionClassAdapter(Context context, List<CityBean> listBean) {
    ...
    public MyIndustryHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_selectposition, parent, false);
        return new MyPositionClassAdapter.MyIndustryHolder(view);
    }
