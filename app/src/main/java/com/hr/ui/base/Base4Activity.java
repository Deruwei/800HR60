...
//    }
//}
public abstract class Base4Activity<T extends BasePresenter, E extends BaseModel> extends AppCompatActivity {
    public  T mPresenter;
    public E mModel;
    ...
    protected abstract void doAtBeforeSetcontentView();
