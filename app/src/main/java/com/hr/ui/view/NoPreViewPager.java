...
public class NoPreViewPager extends ViewGroup {
    private static final String TAG = NoPreViewPager.class.getSimpleName();
    ...
    /**
     * Simple implementation of the {@link //android.support.v4.view.//.OnPageChangeListener} interface with stub
