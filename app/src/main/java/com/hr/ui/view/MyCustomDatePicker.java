...
public class MyCustomDatePicker {
    ...
    public MyCustomDatePicker(Context context, ResultHandler resultHandler) {
            ...
            endYear=Integer.valueOf(currentDate)-18;
    ...
    public void show(String time,int type) {
        if (canAccess) {
            ...
            if (isValidDate(time, "yyyy-M-d")) {
                ...
                selectYear=Integer.valueOf(time.substring(0,time.indexOf("-")))-18;
                selectMonth=12;
                selectDay=getDaysByYearMonth(selectYear,selectMonth);
            }
            ...
            if(type==4) {
                ...
                endYear = Integer.valueOf(currentDate.substring(0, currentDate.indexOf("年")))-18;
            }
            ...
            spanDay=getDaysByYearMonth(selectYear,selectMonth);
            spanYear=endYear;
            spanMon=12;
