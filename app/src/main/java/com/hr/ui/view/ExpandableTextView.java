...
/**
 * Created by wdr on 2017/8/17.
 */

public class ExpandableTextView extends LinearLayout {

    TextView id_source_textview,id_expand_textview;
    ImageView id_expand_imageview;
    LinearLayout id_expand_rl;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        maxExpandLines=array.getInteger(R.styleable.ExpandableTextViewAttr_maxExpandLines, 7);
...
//                requestLayout();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //初始化默认状态，即正常显示文本
        id_expand_rl.setVisibility(GONE);
        ...
        id_expand_rl.setVisibility(VISIBLE);
        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
