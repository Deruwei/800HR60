...
public class VerificationCodeEditText extends android.support.v7.widget.AppCompatEditText implements
    ...
    private void initPopupWindow(Activity activity) {
        View viewIndustry = activity.getLayoutInflater().inflate(R.layout.layout_copy_paste, null);
        popupWindow = new PopupWindow(viewIndustry, LinearLayout.LayoutParams.WRAP_CONTENT,
        ...
        popupWindow.showAsDropDown(this, 20, 5);
    }
    /**
     * 初始化paint
     */
