...
public class CityLetterIndexView extends View {
    ...
    public CityLetterIndexView(Context context) {
        this(context, null);
    }

    public CityLetterIndexView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CityLetterIndexView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public CityLetterIndexView setOverlayTextView(TextView overlay){
        this.mOverlayTextView = overlay;
        return this;
    }

    public CityLetterIndexView setOnIndexChangedListener(OnIndexTouchedChangedListener listener){
