...
/*
   1. noCache 不使用缓存，全部走网络
    ...
    public static OkHttpClient getOkHttpClient(){
        Api retrofitManager = sRetrofitManager.get(HostType.HR);
        if (retrofitManager == null) {
            retrofitManager = new Api(HostType.HR);
            sRetrofitManager.put(HostType.HR, retrofitManager);
        }
    ...
    public static String getCacheControl() {
        return NetWorkUtils.isNetConnected(HRApplication.getAppContext()) ? CACHE_CONTROL_AGE : CACHE_CONTROL_CACHE;
    }
