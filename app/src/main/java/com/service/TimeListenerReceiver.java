...
public class TimeListenerReceiver extends CountDownTimer {
    /**
     * 计时按钮能否点击
     */
     ...
     */
    public TimeListenerReceiver(Context context, long millisInFuture, long countDownInterval, String action) {
